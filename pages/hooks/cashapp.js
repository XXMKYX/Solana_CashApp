...
import {clusterApiUrl, Connection,Keypair,PublicKey,LAMPORTS_PER_SOL,SystemProgram,Transaction} from "@solana/web3.js"; 
...
export const useCashApp = () =>{
   ...
   // const [amount, setAmount] = useState(0)
    ...
    const makeTrasaction = async(fromWallet, toWallet, amount, reference) =>{
        ...
        const {blockhash} = await connection.getLatestBlockhash('Get Latest Blockhask')
